...
public class MainController {
  ...
  @GetMapping(path = "/getOpariakByUmea/{umearenIzena}")
  public List<String> getMethodName(@RequestParam String umeaIzena) {
  ...
  @PostMapping(path = "/addOpariakToUmea")
  public @ResponseBody String addOpariakToUmea(@RequestParam String izena, String oparia) {
    umeaRepository.addOpariToUmea(izena, oparia);
    return "Saved";
  }

  @PutMapping(value = "/opariberria/{umeaId}")
  public ResponseEntity<Umea> updateUmearenOpariak(@Valid @RequestBody String opBerria, @PathVariable String umeaId) {
    try {
  ...
  @PutMapping(value = "/aldatuUmea/{umeaId}{izena}")
  public ResponseEntity<Umea> updateUmea(@Valid @PathVariable String umeaId, @RequestBody String izena) {
    try {
      Umea umea = umeaRepository.findById(umeaId);
      umea.setIzena(izena);
      umeaRepository.save(umea);
