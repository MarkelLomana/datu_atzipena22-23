...
public class MongoDBUmeaRepository implements UmeaRepository {
    ...
    @Override
    public Umea findByOpariak(String id) {
        //List<String> opariak = new ArrayList<>();
        Umea umearenOpariak = umeaCollection.find(eq("_id", id), {"opariak": 1});
        return umearenOpariak;
        //return umeaCollection.find({"_id ":id},{"opariak": 1}) }.count();
    }
